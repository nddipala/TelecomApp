 ...
 *
 * In a production system this would live behind a billing/CRM service backed by
 * a real datastore. For this demo we keep telecom-realistic records in memory and
 * index them by both account ID and phone number so the lookup screen can accept
 * either value.
 */
...
/**
 * Look up an account by account ID or phone number.
 * Accepts loosely-formatted phone input (digits with or without dashes).
 */
